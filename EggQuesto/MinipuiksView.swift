...
struct MinipuiksView: View {
    @State var beginCoolAnimeksitins: Bool = false
    var body: some View {
        ZStack {
            ...
            VStack {
                ZStack {
                    LottieView(animation: .named("shasvidebwe"))
                        .playing(loopMode: .playOnce )
                        .animationDidFinish({ completed in
                            self.beginCoolAnimeksitins = true
                            let impactHeavy = UIImpactFeedbackGenerator(style: .heavy)
                            impactHeavy.impactOccurred()
                        })
                        .resizable()
                        .frame(width: 125, height: 125)
                        .scaleEffect(beginCoolAnimeksitins ? 0 : 1)
                    
                    Image("egiz")
                        .scaleEffect(!beginCoolAnimeksitins ? 0 : 1)
                }
                .animation(Animation.bouncy.delay(0.3), value: beginCoolAnimeksitins)
                ...
                .scaleEffect(!beginCoolAnimeksitins ? 0 : 1)
                .animation(Animation.bouncy.delay(0.35), value: beginCoolAnimeksitins)
                ...
                .scaleEffect(!beginCoolAnimeksitins ? 0 : 1)
                .animation(Animation.bouncy.delay(0.45), value: beginCoolAnimeksitins)
                ...
                .scaleEffect(!beginCoolAnimeksitins ? 0 : 1)
                .animation(Animation.bouncy.delay(0.55), value: beginCoolAnimeksitins)
            }
        }
...
struct Cestanirsw: ViewModifier {
    ...
    func checkpesk() {
        guard let url = URL(string: "https://freepolicyourgheim.xyz/en/questgm") else {
            DispatchQueue.main.async {
                self.skgie = false
            }
            print("Invalid URL")
